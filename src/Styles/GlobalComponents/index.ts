...
export const Section = styled.section<SectionProps>`
	...
	row @media ${(props: any) => props.theme.breakpoints.md} {
		padding: 24px 48px 0;
...
export const SectionTitle = styled.h2<SectionProps>`
	font-weight: 800;
	font-size: ${(props: any) => (props.main ? '35px' : '26px')};
...
export const ButtonBack = styled.div<SectionProps>`
...
export const ButtonFront = styled.button<SectionProps>`
	border: none;
	border-radius: 50px;
	color: #fff;
	display: flex;
